...
package com.vmware.qc.testng.util;
...
public class XmlParser {
    ...
    *
    * @param resource XML resource to load
    * @throws ParserConfigurationException
    * @throws SAXException
    * @throws IOException
    */
   public void loadResource(String resource) throws ParserConfigurationException,
                                                    SAXException,
                                                    IOException {
    ...
    *
    * @param source XML string to load
    * @throws ParserConfigurationException
    * @throws SAXException
    * @throws IOException
    */
   ...
   /**
    * Evaluates the given XPath expression against the context and
    * returns the string value of the result. The context can be a
    * node or nodelist relative to which the expression is to be
    * evaluated. If null, the loaded document object is used.
    *
    * @param expression XPath expression
    * @param context root object (node or nodelist) against which
   ...
   /**
    * Evaluates the given XPath expression against the context and
    * returns the integer value of the result. The context can be a
    * node or nodelist relative to which the expression is to be
    * evaluated. If null, the loaded document object is used.
    *
    * @param expression XPath expression
   ...
   public Integer getInteger(String expression, Object context)
      ...
      return ((Double) xpath.evaluate(expression,
                                      context,
   ...
   /**
    * Evaluates the given XPath expression against the context and
    * returns the boolean value of the result. The context can be a
    * node or nodelist relative to which the expression is to be
    * evaluated. If null, the loaded document object is used.
    *
    * @param expression XPath expression
   ...
   /**
    * Evaluates the given XPath expression against the context and
    * returns the result as a nodelist. The context can be a node
    * or nodelist relative to which the expression is to be
    * evaluated. If null, the loaded document object is used.
    *
    * @param expression XPath expression
    * @param context root object (node or nodelist) against which
   ...
   public NodeList getNodeList(String expression, Object context)
      ...
      return (NodeList) xpath.evaluate(expression,
                                       context,
   ...
   /**
    * Evaluates the given XPath expression against the context and
    * returns the result as a node. The context can be a node
    * or nodelist relative to which the expression is to be
    * evaluated. If null, the loaded document object is used.
    *
    * @param expression XPath expression
